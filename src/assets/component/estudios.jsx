...
function estudios() {
  return (
   ...
   <img className='estudio' src="https://drive.google.com/uc?id=1FPmRbEWvh3bSQgmNlP3JyzL4KPJqjLr7" alt="Desarrollo de juegos" />
   <img className='estudio' src="https://drive.google.com/uc?id=1FJXGhwpOSRE0Mf89UibL7qad3g_9gn9v" alt="Frond-end 3" />
